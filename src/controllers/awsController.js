...
let uploadFile = async (file) => {
    return new Promise(function (resolve, reject) { // exactly 
        ...
        var uploadParams = {
            ...
            Key: "BookCover" + Date.now() + file.originalname, // HERE    "pk_newFolder/harry-potter.png" pk_newFolder/harry-potter.png
            Body: file.buffer,
        };
...
let awsCreate = async function (req, res) {
...
module.exports.awsCreate = awsCreate;